 ...
 */
final class Version20210712094649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT AUTO_INCREMENT NOT NULL, status_id INT DEFAULT NULL, contact_information_id INT DEFAULT NULL, user_id INT DEFAULT NULL, shipping_address_id INT DEFAULT NULL, project_name VARCHAR(255) NOT NULL, quantity INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_8ECAEAD46BF700BD (status_id), INDEX IDX_8ECAEAD45D0DBFC1 (contact_information_id), INDEX IDX_8ECAEAD4A76ED395 (user_id), INDEX IDX_8ECAEAD44D4CFF2B (shipping_address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
